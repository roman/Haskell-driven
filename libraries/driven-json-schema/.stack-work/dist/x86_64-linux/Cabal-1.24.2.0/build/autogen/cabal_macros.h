...
/* package hjsonschema-1.5.0.1 */
#define VERSION_hjsonschema "1.5.0.1"
#define MIN_VERSION_hjsonschema(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  5 || \
...
#define CURRENT_COMPONENT_ID "driven-json-schema-0.1.0.0-KuUCWXjwpG6HTwcoIcSRie"

#define CURRENT_PACKAGE_KEY "driven-json-schema-0.1.0.0-KuUCWXjwpG6HTwcoIcSRie"
